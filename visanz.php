...
<section class="page-hero">
  <img src="assets/images/Hero/nzhobbit.png" alt="New Zealand Hero">
  <div class="page-hero-text">
    <h1>New Zealand Visa Requirements</h1>
  </div>
</section>
...
<section id="visaIntro">
  <h2>New Zealand Visa Application for Filipino Travelers</h2>
  <p>
    Filipino citizens planning to visit New Zealand are required to obtain a New Zealand Visitor Visa before traveling, 
    unless eligible for a visa waiver or an NZeTA (New Zealand Electronic Travel Authority). 
    This visa allows short-term stays for purposes such as tourism, visiting family or friends, business trips, or attending short courses and events. 
  ...
  <div class="visa-countries">
    ...
    <p>
      A New Zealand visa grants entry into the islands of New Zealand, including both the North and South Islands, as well as surrounding smaller islands. 
      Popular destinations include Auckland, Wellington, Christchurch, Queenstown, and Rotorua — each offering unique natural beauty and cultural experiences.
    </p>

    <div class="country-grid">
      <a href="visanewzealand.php?country=newzealand" class="country-item">
        <img src="assets/images/icons/countries/nz.png" alt="New Zealand"> New Zealand
      </a>
    </div>
  </div>
</section>
...
<section id="visaTabsSection">
 ...
 <!-- =============== TAB 2 =============== -->
  ...
  <ol>
    <li><a href="assets/docs/New_Zealand_Short-stay_Visa_Checklist.pdf" target="_blank">New Zealand Short-stay Visa Checklist</a></li>
  </ol>
    <h1>New Zealand Tourist Visa</h1>
    <ul>
        <li><p>Completed application forms</p></li>
        <p>-INZ 1017 (for visiting purpose) </p>
        <p>-INZ 1189 (for Tourist/Business purposes) </p>
        <li><p> Original Current and old passport(s)</p></li>
        <li><p>Copy of new and old passports (first page and all pages with visas and stamps) </p></li>
        <li><p> Copy of Alien Certificate of Registration (ACR) for non-Filipino applicants </p></li>
        <li><p>2 passport size photos (white background, no eyeglasses, both ears exposed,neutral expression) </p></li>
        <li><p>If employed: Certificate of Employment and copy of ITR 2316 </p></li>
        <li><p>If self-employed: proof of business registration such as SEC registration, DTI, business permits and Income tax returns </i></b></p></li>
        <li><p>Copy of birth certificate </p></li>
        <li><p>Copy of marriage contract if married </p></li>
        <li><p>For minors, affidavit of support and consent to travel from both parents </p></li>
        <li><p>Copy of itinerary </p></li>
        <li><p>Copy of roundtrip flight booking </p></li>
        <li><p>Copy of hotel booking in New Zealand</p></li>
        <li><p> If visiting relatives or friends, provide all documents below: </p></li>
        <ol>
            <li><p>Letter of invitation from your relative or friend in Australia</p></li>
            <li><p>Copy of passport biopage</p></li>
            <li><p>Evidence of your relationship to your relative or friend </p></li>
            <li><p>Evidence that they have the necessary funds to support your intended stay</p></li>
       </ol>
    </ul>
      <ul>
        <h2>Additional Requirement for Incentive Trip</h2>
        <li><p>Letter of Guarantee from the Company</p></li>
        <li><p>Copy of business registration (SEC) </p></li>
        <li><p>Company ITR </p></li>
        <li><p>Company Bank Certificate</p></li>
    </ul>
  </div>

<!-- =============== TAB 3 =============== -->
<div id="form" class="tab-content">
  <h3>New Zealand Visa Pre-Application Form</h3>
  <p class="form-intro">
...
<form id="visaPreApp" action="backend/send_visa_application.php" method="POST" enctype="multipart/form-data" novalidate>
  <input type="hidden" name="visa_type" value="New Zealand Visa">
...
<div id="contact" class="tab-content">
  ...
  <b>Ms. Lourdes Michelle D. Peña</b> – President<br>
  📱 <a href="tel:+639989833975">+63 998 983 3975</a></p>

  <p>If you have any inquiries or need help with your New Zealand visa process, please reach out using the contact details above or send us a message below.</p>
